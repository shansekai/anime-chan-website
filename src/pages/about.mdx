...
[Animechanapi][animechanapi] is a node based rest api that serves thousands of anime quotes.You can query
quotes based on any characters and animes.

[Checkout The documentation to get started](/documentation)

### Reason

The primary reason behind creating this api was that I personally could not find a single api that serves anime quotes.There are several
...
If you like the project then please leave a star :star: in the [repository.][animechanapi] That helps to keep me motivated
